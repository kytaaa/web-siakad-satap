...
@error('id_card')
  <script>
    toastr.error("Maaf User ini tidak terdaftar sebagai Guru SMPN Satu Atap 1 Jati Agung!");
  </script>
@enderror
@error('guru')
  <script>
...
@error('no_induk')
  <script>
    toastr.error("Maaf User ini tidak terdaftar sebagai Siswa SMPN Satu Atap 1 Jati Agung!");
  </script>
@enderror
@error('siswa')
  <script>
